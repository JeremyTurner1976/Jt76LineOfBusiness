(function($) {
    ...
    $(document).ready(function() {
        ...
        $('#intro').backstretch(['/Content/Images/bg3.jpg']);
        ...
        //only run this if the 'map' div is in the view
        if (typeof GMaps !== 'undefined') {

            var dLat = 47.492;
            var dLng = -117.586;

            var image = new google.maps.MarkerImage('/Content/Images/map-icon.png',
            ...
            map.addMarker({
                ...
                lng: dLng,
                icon: image,
                title: 'EWU - The Alma Mater' //,
                //infoWindow: {
                //    content: '<p><strong>EWU</strong><br/>Proud Graduate</p>'
                //}
            });
        }
